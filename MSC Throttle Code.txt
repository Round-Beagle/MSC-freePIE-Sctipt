	...
	# =============================================================================================
"""This script has been tuned for use with My Summer Car by Randox.
	...
	I've also included the necessary code for mouse steering, commented out. The code I used can be
...
if starting:    
	...
	global space_reset_enabled, low_mode_enabled
	throttle_key = Key.W
	...
	global braking, braking_max, braking_increase_rate, braking_decrease_rate, braking_sec
    #initialization values. Do not change.
	throttle_max = int32_max
	braking_max = int32_min
	throttle_min = 0
    ...
    #braking rates use a multiple of throttle rates. 1 is same, >1 is faster, <1 is slower
    #feel free to change, but multiplier MUST be negative
	braking_increase_rate = throttle_increase_rate * -1
	braking_decrease_rate = throttle_decrease_rate * -0.5
...
if keyboard.getKeyDown(throttle_key):
...
elif keyboard.getKeyDown(brake_key):
	if throttle > 0:
		throttle = 0
	if throttle_hold_set == True:
		throttle = throttle + (braking_increase_rate * throttle_inc_mod)
	else:
		throttle = throttle + braking_increase_rate
	...
	if throttle_hold_set == True:
		throttle = throttle + (braking_decrease_rate * throttle_dec_mod)
	else:
		throttle = throttle + braking_decrease_rate
	if throttle > 0:
		throttle = 0
...
elif throttle < braking_sec and throttle_sec_set == True:
	throttle = braking_sec
elif throttle > throttle_max:
    throttle = throttle_max
elif throttle < braking_max:
    throttle = braking_max
v.y = throttle
# =================================================================================================
# Steering logic
# =================================================================================================
